...
class CategoryV1Factory extends
    ...
    @Override
    public RESTCategoryV1 createRESTEntityFromDBEntityInternal(final Category entity, final String baseUrl,
        ...
        if (revision == null && expand != null && expand.contains(RESTBaseEntityV1.REVISIONS_NAME)) {
            retValue.setRevisions(new RESTDataObjectCollectionFactory<RESTCategoryV1, Category, RESTCategoryCollectionV1, RESTCategoryCollectionItemV1>()
                    .create(RESTCategoryCollectionV1.class, new CategoryV1Factory(), entity,
        ...
        if (expand != null && expand.contains(RESTCategoryV1.TAGS_NAME)) {
            retValue.setTags(new RESTDataObjectCollectionFactory<RESTTagInCategoryV1, TagToCategory, RESTTagInCategoryCollectionV1, RESTTagInCategoryCollectionItemV1>()
                    .create(RESTTagInCategoryCollectionV1.class, new TagInCategoryV1Factory(),
                            entity.getTagToCategoriesArray(), RESTCategoryV1.TAGS_NAME, dataType, expand, baseUrl,
                            entityManager));
        }
