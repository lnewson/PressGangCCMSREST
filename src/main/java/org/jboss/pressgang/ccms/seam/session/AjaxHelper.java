...
public class AjaxHelper
{
	...
	public String getTranslatedTopicUrl()
	{
		String retValue = "";

		if (baseUrl != null && topicId != null)
			retValue = baseUrl + "?translatedTopicId=" + topicId;
		if (otherVars != null && otherVars.length() != 0)
			retValue += "&" + otherVars;
	...
	public String getTranslatedTopicUrlAndEndConversation()
	{
		if (otherVars == null)
			otherVars = "";
		else if (otherVars.length() != 0)
