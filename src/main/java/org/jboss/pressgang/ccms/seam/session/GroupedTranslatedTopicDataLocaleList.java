...
public class GroupedTranslatedTopicDataLocaleList extends GroupedLocaleListBase<GroupedTranslatedTopicDataList> {
    ...
    public void create() {
        ...
        for (String locale : locales) {
            final GroupedTranslatedTopicDataList translatedTopicDataList = new GroupedTranslatedTopicDataList(locale, filterQueryBuilder,
                    this, expectedTotalTranslationCount);
    ...
    public List<GroupedList<TranslatedTopicDataList>> getLocaleGroupedLists(String locale) {
        return groupedLocales.containsKey(locale) ? groupedLocales.get(
                locale).getGroupedLists() : new ArrayList<GroupedList<TranslatedTopicDataList>>();
    }
    ...
    public void setSelectedTab(final String selectedTab) {
        final GroupedTranslatedTopicDataList translatedTopicDataList = getTranslatedTopicDataList(localeTab);
        if (translatedTopicDataList != null) translatedTopicDataList.tab = selectedTab;
    }
    ...
    public boolean isNextExists() {
        ...
        return pagingEntityQuery == null || pagingEntityQuery.getMaxResults() == null || pagingEntityQuery.getResultCount() == null ?
                false : (((pagingEntityQuery.getFirstResult() == null ? 0 : pagingEntityQuery.getFirstResult()) + pagingEntityQuery
                .getMaxResults()) < pagingEntityQuery.getResultCount());
