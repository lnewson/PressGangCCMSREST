...
public class GroupedTopicListBase extends GroupedListBase<ExtendedTopicList> {
    ...
    public void create() {
        ...
        for (final Tag tag : urlGroupedTags) {
            ...
            if (topics.getResultCount() != 0) {
                ...
                if (pagingEntityQuery == null || pagingEntityQuery.getResultCount() < topics.getResultCount()) pagingEntityQuery = topics;
        ...
        if (groupedLists.size() != 0) this.tab = groupedLists.get(0).getGroup();
    }

    public void removeRelationship() {
        try {
            if (!(actionTopicId != null && otherTopicId != null && relationshipTagId != null)) throw new IllegalArgumentException();
    ...
    public String viewRelatedTopic() {
        try {
            if (otherTopicId != null) return "/Topic.xhtml?topicTopicId=" + otherTopicId;
